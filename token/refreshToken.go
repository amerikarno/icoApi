...
// New refresh claim.
// Issue at = Now()
func NewRefreshClaims(u *models.JwtUserModel) (rc *RefreshClaims) {
	rc = &RefreshClaims{JwtUserModel: *u, TokenID: *NewTokenID()}
	n := now()
...
func ExtractRefreshClaims(c echo.Context, option ...jwt.ParserOption) (*RefreshClaims, error) {
